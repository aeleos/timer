...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_scout", Command_Scout, ADMFLAG_CUSTOM3, "Give player a scout");
	RegAdminCmd("sm_usp", Command_Usp, ADMFLAG_CUSTOM3, "Give player a usp");
	RegAdminCmd("sm_glock", Command_Glock, ADMFLAG_CUSTOM3, "Give player a glock");
