...
{
	Format(web, sizeof(web), "http://www.lgservers.org/webshortcuts/webshortcuts2.php?web=%s;franug_is_pro;%s", title,web);
}

stock FixMotdCSGO_fullsize(String:web[512])
{
	Format(web, sizeof(web), "http://www.lgservers.org/webshortcuts/webshortcuts.html?web=%s", web);
}
